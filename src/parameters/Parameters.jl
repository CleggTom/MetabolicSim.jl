...
- `Rm::Vector{Float64}`: Vector of maintennce respiration costs for consumers
- `l::Array{Float64,2}`: Array of the proportion of uptake of resource i released as resource j
- `l_sum::Vector{Float64}`: Array of the total proportion of uptake of resource j released
- `ρ::Vector{Float64}`: Vector of inflow rates for resources
